...
2. Score each **tgt → en** translation using BLEU/chrF/whatever
...
3. Run GRPO with two mixed tasks:
...
- Allows you to use any monolingual data to tune translation in _both directions_ for _any target language_
